...
# Каталог библиотеки сериалов Jellyfin на хосте. В контейнере он доступен как /media/shows.
ANIME_DIRECTORY = "/srv/smalldata/media/shows"
MAX_BATCH_EPISODES = 2000 # Защита от ошибочного или вредоносного диапазона, не мешающая длинным сериалам
